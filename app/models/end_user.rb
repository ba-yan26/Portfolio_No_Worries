class EndUser < ApplicationRecord
  ...
  has_many :active_reviews, class_name: "Review", foreign_key: :reviewer_id
  has_many :reviewers, through: :active_reviews, source: :reviewing
  # ユーザーがレビューしている人をreviewテーブルを介して取ってくる
  has_many :passive_reviews, class_name: "Review", foreign_key: :reviewing_id
  has_many :reviewings, through: :passive_reviews, source: :reviewer
  # ユーザーをレビューしている人をreviewテーブルを介して取ってくる
